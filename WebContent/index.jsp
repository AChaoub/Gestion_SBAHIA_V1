...
<html>
	...
	<style id="applicationStylesheet" type="text/css">
		...
		* {
		...
		#Freelancer_is_a_free_bootstrap {
			left: 374px;
			top: 2073px;
			position: absolute;
			overflow: visible;
		...
		#Freelancer_is_a_free_bootstrap_b {
			left: 1075px;
			top: 2073px;
			position: absolute;
			overflow: visible;
		...
		var Application = function () {
			...
			self.updateLastModifiedLabel = function () {
				...
				if (self.lastModifiedLabel) {
					var seconds = parseInt(((new Date().getTime() - Date.parse(document.lastModified)) / 1000 / 60) *
						100 + "");
					var minutes = 0;
					var hours = 0;
    ...
    <body>
        ...
        <div id="Web_1920__1"></div>
	<div id="Grille_Gallerie">
		<div id="Grille_Gallerie_0" class="">
			<div id="Gallerie">
				<div id="Gallerie_0" class="">
					<div id="GALLERIE__w">
						<span>GALLERIE</span><br>
					</div>
					<svg class="Rectangle_5">
						<rect id="Rectangle_5" rx="8" ry="8" x="0" y="0" width="367" height="16">
						</rect>
					</svg>
					<svg class="Rectangle_6">
						<rect id="Rectangle_6" rx="8" ry="8" x="0" y="0" width="367" height="16">
						</rect>
					</svg>
                                        <img id="Blackhearth" src="assets/img/portfolio/Blackhearth.png" >

				</div>
			</div>
			<div id="Grille_de_rptition_7">
				<div id="Grille_de_rptition_7_0" class="">
					<div id="Grille_de_rptition_6">
						<div id="Grille_de_rptition_6_0" class="">
							<svg class="Rectangle_7">
								<rect id="Rectangle_7" rx="0" ry="0" x="0" y="0" width="444" height="288">
								</rect>
							</svg>
							<img id="pexels-photo-3010771" src=assets/img/portfolio/p1.jpeg">
						</div>
					</div>
					<div id="Grille_de_rptition_5">
						<div id="Grille_de_rptition_5_0" class="">
							<svg class="Rectangle_7_">
								<rect id="Rectangle_7_" rx="0" ry="0" x="0" y="0" width="444" height="288">
								</rect>
							</svg>
							<img id="pexels-photo-6739702" src="assets/img/portfolio/p3.jpeg">

						</div>
					</div>
					<div id="Grille_de_rptition_4">
						<div id="Grille_de_rptition_4_0" class="">
							<svg class="Rectangle_7_bc">
								<rect id="Rectangle_7_bc" rx="0" ry="0" x="0" y="0" width="444" height="288">
								</rect>
							</svg>
							<img id="pexels-photo-1299686" src="assets/img/portfolio/p4.jpeg">

						</div>
					</div>
					<div id="Grille_de_rptition_3">
						<div id="Grille_de_rptition_3_0" class="">
							<svg class="Rectangle_7_bg">
								<rect id="Rectangle_7_bg" rx="0" ry="0" x="0" y="0" width="444" height="288">
								</rect>
							</svg>
							<img id="pexels-photo-3094018" src="assets/img/portfolio/p5.jpeg">

						</div>
					</div>
					<div id="Grille_de_rptition_2">
						<div id="Grille_de_rptition_2_0" class="">
							<svg class="Rectangle_7_bk">
								<rect id="Rectangle_7_bk" rx="0" ry="0" x="0" y="0" width="444" height="288">
								</rect>
							</svg>
							<img id="pexels-photo-6739229" src="assets/img/portfolio/p6.jpeg">

						</div>
					</div>
					<div id="Grille_de_rptition_1">
						<div id="Grille_de_rptition_1_0" class="">
							<svg class="Rectangle_7_bo">
								<rect id="Rectangle_7_bo" rx="0" ry="0" x="0" y="0" width="444" height="288">
								</rect>
							</svg>
							<img id="pexels-photo-2377910" src="assets/img/portfolio/pottery.jpeg">
	...
	<div id="Grille_about">
		<div id="Grille_about_0" class="">
			<div id="Sbahia">
				<div id="Sbahia_0" class="">
					<svg class="Rectangle_2">
						<rect id="Rectangle_2" rx="0" ry="0" x="0" y="0" width="1920" height="779">
						</rect>
					</svg>
                    <img id="pottery" src="assets/img/portfolio/p1.jpeg">
					<div id="Grille_de_rptition_10">
						<div id="Grille_de_rptition_10_0" class="">
							<div id="SBAHIA_">
								<span>S'BAHIA </span>
							</div>
							<svg class="Rectangle_3">
								<rect id="Rectangle_3" rx="8" ry="8" x="0" y="0" width="367" height="16">
								</rect>
							</svg>
							<svg class="Rectangle_4">
								<rect id="Rectangle_4" rx="8" ry="8" x="0" y="0" width="367" height="16">
								</rect>
							</svg>
                           	<img id="heart" src="assets/img/portfolio/heart.png" >
			...
			<svg class="Rectangle_8">
				<rect id="Rectangle_8" rx="0" ry="0" x="0" y="0" width="1920" height="686">
				</rect>
			</svg>
			<div id="ABOUT_">
				<span>ABOUT</span><br>
			...
			<svg class="Rectangle_9">
				<rect id="Rectangle_9" rx="8" ry="8" x="0" y="0" width="367" height="16">
				</rect>
			</svg>
			<svg class="Rectangle_10">
				<rect id="Rectangle_10" rx="8" ry="8" x="0" y="0" width="367" height="16">
				</rect>
			</svg>
                        <img id="heart_b" src="assets/img/portfolio/Blackhearth.png">

			<div id="Freelancer_is_a_free_bootstrap">
				<span>Freelancer is a free bootstrap <br />theme created by Start Bootstrap. <br />The download
					includes the <br />complete source files including<br /> HTML, CSS, and JavaScript as<br /> well
					as optional SASS <br />stylesheets for easy customization.</span>
			</div>
			<div id="Freelancer_is_a_free_bootstrap_b">
				<span>Freelancer is a free bootstrap <br />theme created by Start Bootstrap. <br />The download
					includes the <br />complete source files including<br /> HTML, CSS, and JavaScript as<br /> well
					as optional SASS <br />stylesheets for easy customization.</span>
			</div>
	...
	<div id="Grille_contact">
		<div id="Grille_contact_0" class="">
			<div id="Grille_de_rptition_8">
				<div id="Grille_de_rptition_8_0" class="">
					<div id="CONTACT_">
						<span>CONTACT</span><br>
					</div>
					<svg class="Rectangle_11">
						<rect id="Rectangle_11" rx="8" ry="8" x="0" y="0" width="367" height="16">
						</rect>
					</svg>
					<svg class="Rectangle_12">
						<rect id="Rectangle_12" rx="8" ry="8" x="0" y="0" width="367" height="16">
						</rect>
					</svg>
					<img id="Blackhearth_cg" src="assets/img/portfolio/Blackhearth.png">

				</div>
			</div>
			<div id="Grille_de_rptition_9">
				<div id="Grille_de_rptition_9_0" class="">
					<svg class="Ellipse_1">
						<ellipse id="Ellipse_1" rx="102.5" ry="102.5" cx="102.5" cy="102.5">
						</ellipse>
					</svg>
					<svg class="Ellipse_3">
					...
					<svg class="Ellipse_2">
						<ellipse id="Ellipse_2" rx="5" ry="0.5" cx="5" cy="0.5">
						</ellipse>
					</svg>
                                        <img id="smartphone" src="assets/img/portfolio/smartphone.png">

                                        <img id="email" src="assets/img/portfolio/email.png" >
					...
					<div id="ID555_555-5555">
						<span>(555) 555-5555</span>
					</div>
					<div id="AdminSBahiacom">
						<span>Admin@S'Bahia.com</span>
					</div>
				</div>
			</div>
		</div>
